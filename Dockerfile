...
WORKDIR $GOPATH/src/github.com/edgexfoundry/device-udp-go
...
COPY --from=builder /go/src/github.com/edgexfoundry/device-udp-go/cmd /

ENTRYPOINT ["/device-udp-go","--profile=docker","--confdir=/res","--registry=consul://edgex-core-consul:8500"]
